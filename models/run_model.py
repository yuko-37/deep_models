...
def run_many():
    ...
    parameters, costs = L_layers_model(train_x, train_y, layers_dims, num_iterations, learning_rate)
    print()
    predict(train_x, train_y, parameters, num_iterations, learning_rate, 'train set')
    predict(test_x, test_y, parameters, num_iterations, learning_rate, 'test set')
    print()
    costs_set.append(costs)
    labels_set.append(label(learning_rate, layers_dims))
...
if __name__ == '__main__':
    ...
    # recognize_image_array(img_array, file_from_dims(layers_dims))

    # recognize_image('cat-0.jpg', file_from_dims(layers_dims))
    # recognize_image('cat-ara.jpeg', file_from_dims(layers_dims))
    # recognize_image('cat-test-2.png', file_from_dims(layers_dims))
